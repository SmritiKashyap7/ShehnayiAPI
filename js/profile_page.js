...
fetch("https://server.shehnayi.in/api/v2/home", {
  ...
  .then((data) => {
    ...
    document.querySelector(
      ".apippsubcaste"
    ).innerHTML = `${data.foundUser.subCaste}`;
    document.querySelector(
      ".apippmaritalstatus"
    ).innerHTML = `${data.foundUser.maritalStatus}`;
    document.querySelector(
      ".apippplace"
    ).innerHTML = `Lives in ${data.foundUser.city}, ${data.foundUser.state}`;
    document.querySelector(
      ".apippdesignation"
    ).innerHTML = `${data.foundUser.designation}`;
    document.querySelector(
      ".apippdesc"
    ).innerHTML = `${data.foundUser.profileSummary}`;
    document.querySelector(
      ".apippusername"
    ).innerHTML = `${data.foundUser.firstname} ${data.foundUser.lastname}`;
    document.querySelector(
      ".apippbday"
    ).innerHTML = `${data.foundUser.birthday.day}/${data.foundUser.birthday.month}/${data.foundUser.birthday.year}`;
    ...
    document.querySelector(
      ".apippmangliks"
    ).innerHTML = `${data.foundUser.manglik}`;
    document.querySelector(
      ".apippuhq"
    ...
    document.querySelector(
      ".apippdrink"
    ).innerHTML = `${data.foundUser.drinking}`;
    document.querySelector(
      ".apippsmoke"
    ).innerHTML = `${data.foundUser.smoking}`;
    document.querySelector(
      ".apippfr"
    ).innerHTML = `${data.foundUser.fatherStatus}`;
    document.querySelector(
      ".apippmr"
    ).innerHTML = `${data.foundUser.motherStatus}`;
    document.querySelector(
      ".apippnbr"
    ).innerHTML = `${data.foundUser.brothers}`;
    document.querySelector(".apippns").innerHTML = `${data.foundUser.sisters}`;

    document.querySelector(
      ".apipppage"
    ).innerHTML = `${data.foundUser.userPreference.fromAge} to ${data.foundUser.userPreference.toAge} yrs`;
    document.querySelector(
      ".apippph"
    ).innerHTML = `${data.foundUser.userPreference.fromHeight} to ${data.foundUser.userPreference.toHeight}`;
    document.querySelector(
      ".apipppms"
    ).innerHTML = `${data.foundUser.userPreference.maritalStatus}`;
    document.querySelector(
      ".apippprg"
    ).innerHTML = `${data.foundUser.userPreference.religion}`;
    document.querySelector(
      ".apipppcs"
    ...
    document.querySelector(
      ".apipppstate"
    ).innerHTML = `${data.foundUser.userPreference.state}`;
    document.querySelector(
      ".apipppcountry"
    ).innerHTML = `${data.foundUser.userPreference.country}`;
    document.querySelector(
      ".apippphq"
    ).innerHTML = `${data.foundUser.userPreference.heighestQualification}`;
    document.querySelector(
      ".apipppcompany"
    ).innerHTML = `${data.foundUser.userPreference.company}`;
    document.querySelector(
      ".apipppannum"
    ).innerHTML = `${data.foundUser.userPreference.AnnualIncome}`;
...
// Close buttons
document
  .querySelector("#inner-form-1 #close-icon-1")
  .addEventListener("click", function () {
    popup();
  });

document
  .querySelector("#inner-form-2 #close-icon-2")
  .addEventListener("click", function () {
    popup();
  });

document
  .querySelector("#inner-form-3 #close-icon-3")
  .addEventListener("click", function () {
    popup();
  });

document
  .querySelector("#inner-form-4 #close-icon-4")
  .addEventListener("click", function () {
    popup();
  });

document
  .querySelector("#inner-form-5 #close-icon-5")
  .addEventListener("click", function () {
    popup();
  });

document
  .querySelector("#inner-form-6 #close-icon-6")
  .addEventListener("click", function () {
    popup();
  });

document
  .querySelector("#inner-form-7 #close-icon-7")
  .addEventListener("click", function () {
    popup();
  });

document
  .querySelector("#inner-form-8 #close-icon-8")
  .addEventListener("click", function () {
    popup();
  });
...
// Form slides
document
  .querySelector("#inner-form-1 .nexti-btn")
...
document
  .querySelector("#inner-form-2 .flex-div .previ-btn")
  .addEventListener("click", function () {
...
document
  .querySelector("#inner-form-2 .nexti-btn")
  .addEventListener("click", function (event) {
    document.querySelector("#inner-form-2").style.display = "none";
...
document
  .querySelector("#inner-form-3 .previ-btn")
  .addEventListener("click", function () {
...
document
  .querySelector("#inner-form-3 .nexti-btn")
  .addEventListener("click", function (event) {
    document.querySelector("#inner-form-3").style.display = "none";
...
document
  .querySelector("#inner-form-4 .previ-btn")
  .addEventListener("click", function () {
...
document
  .querySelector("#inner-form-4 .nexti-btn")
  .addEventListener("click", function (event) {
    document.querySelector("#inner-form-4").style.display = "none";
...
document
  .querySelector("#inner-form-5 .previ-btn")
  .addEventListener("click", function () {
...
document
  .querySelector("#inner-form-5 .nexti-btn")
  .addEventListener("click", function (event) {
    document.querySelector("#inner-form-5").style.display = "none";
...
document
  .querySelector("#inner-form-6 .previ-btn")
  .addEventListener("click", function () {
...
document
  .querySelector("#inner-form-6 .nexti-btn")
  .addEventListener("click", function (event) {
    document.querySelector("#inner-form-6").style.display = "none";
...
document
  .querySelector("#inner-form-7 .previ-btn")
  .addEventListener("click", function () {
...
document
  .querySelector("#inner-form-7 .nexti-btn")
  .addEventListener("click", function (event) {
    document.querySelector("#inner-form-7").style.display = "none";
...
document
  .querySelector("#inner-form-8 .previ-btn")
  .addEventListener("click", function () {
